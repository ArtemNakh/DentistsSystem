...
import { useAppDispatch, useAppSelector, UseDenormalizeSelector } from "@/lib/redux/hooks";
...
export default function PaymentsList({ filters }: PaymentsListProps) {
  const payments:IPayment[] = Object.values(UseDenormalizeSelector((state:RootState)=>state.payments))?? {}
